// 🎯 GRITA: "Sección de experiencia laboral profesional"
"use client";
                ...
                >
                  <div className={`flex items-center ${index % 2 === 0 ? 'md:justify-end' : 'md:justify-start'}`}>
                    <div className="relative ml-8 md:ml-0 flex-1 md:max-w-md">
                      ...
                      <div className={`absolute top-6 ${index % 2 === 0 ? 'md:-right-[2.15rem] -left-[2.15rem]' : 'md:-left-[2.15rem] -left-[2.15rem]'} w-4 h-4 bg-purple-600 rounded-full border-4 border-gray-800`}></div>
